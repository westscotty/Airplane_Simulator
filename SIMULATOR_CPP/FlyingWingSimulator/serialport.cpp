/**********************************************************
 * File: SerialPort.cpp
 * Purpose: Establish class functions and arduino connection
...
SerialPort::SerialPort(const char* portName)    // Sets up serial port so this can be called each time to communicaite with the serial port
{
    ...
    this->handler = CreateFileA(static_cast<LPCSTR>(portName),
        ...
        NULL);
    if (this->handler == INVALID_HANDLE_VALUE)            //Check if Com Port is invalid
    {
